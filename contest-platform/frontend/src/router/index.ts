...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/contests', name: 'Contests', component: Contests },
      { path: '/contests/create', name: 'ContestCreate', component: () => import('@/views/ContestCreate.vue') },
      { path: '/contests/:slug', name: 'ContestDetail', component: () => import('@/views/ContestDetail.vue') },

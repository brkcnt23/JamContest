...
const companyLogo = (seed) => `https://api.dicebear.com/7.x/identicon/svg?seed=${seed}`;
async function main() {
    ...
    const userDefs = [
        ...
        { email: 'murat@creativemail.net', username: 'murat_pixel', displayName: 'Murat Taş', bio: 'Pixel art ve retro oyunlar tutkunu. Aseprite ile 16x16\'dan 128x128\'e her şeyi çizerim.', tagline: 'Piksellerle dünya kurmak', portfolioLink: 'https://murattas.itch.io', contactTwitter: 'murattas_pixel', globalRole: client_1.GlobalRole.USER },
        { email: 'aysun@artmail.co', username: 'aysun_water', displayName: 'Aysun Demir', bio: 'Suluboya ve dijital karışık medya sanatçısı. Doğa, mitoloji ve rüya temaları.', tagline: 'Renklerin dansı', contactInstagram: 'aysunwatercolor', globalRole: client_1.GlobalRole.USER },
        ...
        // Fotoğrafçılar
        { email: 'leyla@photofocus.net', username: 'leyla_photo', displayName: 'Leyla Gezgin', bio: 'Belgesel ve sokak fotoğrafçısı. 15 ülkede çekim yaptı. National Geographic Türkiye yayını.', tagline: 'Anı dondurmak', portfolioLink: 'https://leylagezgin.com', contactInstagram: 'leylagezginphoto', contactTwitter: 'leylagezgin', globalRole: client_1.GlobalRole.USER },
        { email: 'tarkan@photofocus.net', username: 'tarkan_foto', displayName: 'Tarkan Özkan', bio: 'Doğa ve manzara fotoğrafçısı. Uzun pozlama ve astrofotoğrafi uzmanı.', tagline: 'Işığın peşinde', portfolioLink: 'https://tarkanozkan.photo', contactInstagram: 'tarkanophoto', globalRole: client_1.GlobalRole.USER },
        // Müzisyenler / Ses
        { email: 'ece@audiomail.net', username: 'ece_music', displayName: 'Ece Solmaz', bio: 'Film ve oyun müziği bestecisi. Ambient, orkestral ve elektronik türlerde çalışıyorum.', tagline: 'Sessizliğe notalar eklemek', portfolioLink: 'https://soundcloud.com/ecesolmaz', contactTwitter: 'ecesolmazmusic', globalRole: client_1.GlobalRole.USER },
        { email: 'kerem@audiomail.net', username: 'kerem_sound', displayName: 'Kerem Yalçın', bio: 'Ses tasarımcısı ve foley artist. 20+ indie oyuna ses ve müzik yaptım.', tagline: 'Her ses bir hikaye', portfolioLink: 'https://keremsound.design', contactInstagram: 'keremsoundesign', globalRole: client_1.GlobalRole.USER },
        // Geliştiriciler / Oyun
        { email: 'pelin@devhub.io', username: 'pelin_dev', displayName: 'Pelin Aksu', bio: 'Unity & Unreal geliştirici. 5 indie oyun, 2 mobil uygulama. Oyun jam\'leri benim için yaşam tarzı.', tagline: 'Kodla sanat yapmak', portfolioLink: 'https://pelinaksu.dev', contactTwitter: 'pelinaksudev', globalRole: client_1.GlobalRole.USER },
        { email: 'cengiz@devhub.io', username: 'cengiz_code', displayName: 'Cengiz Bulut', bio: 'Full-stack developer ve araç geliştirici. Yaratıcılar için open-source araçlar yazıyorum.', tagline: 'Araç yap, yaratıcılar kullansın', portfolioLink: 'https://github.com/cengizbulut', contactTwitter: 'cengizbulutdev', globalRole: client_1.GlobalRole.USER },
        // Tasarımcılar
        { email: 'damla@designhub.net', username: 'damla_ui', displayName: 'Damla Şener', bio: 'Senior UI/UX tasarımcı. Fintech, SaaS ve oyun sektörlerinde 9 yıl deneyim.', tagline: 'Kullanıcı önce gelir', portfolioLink: 'https://damlasener.design', contactBehance: 'damlasener', globalRole: client_1.GlobalRole.USER },
        { email: 'yigit@designhub.net', username: 'yigit_brand', displayName: 'Yiğit Karaca', bio: 'Marka kimliği ve logo tasarımı. 100+ markaya görsel kimlik oluşturdum.', tagline: 'Markaları görünür kılmak', portfolioLink: 'https://yigitkaraca.design', contactInstagram: 'yigitbranding', globalRole: client_1.GlobalRole.USER },
        // Yazarlar
        { email: 'gulce@writersden.net', username: 'gulce_writer', displayName: 'Gülce Özdemir', bio: 'Kısa öykü yazarı ve içerik editörü. 2 kitap, 50+ yayınlanmış öykü.', tagline: 'Kelimelerle evren kurmak', portfolioLink: 'https://gulceozdemir.com', contactTwitter: 'gulceozdemirwriter', globalRole: client_1.GlobalRole.USER },
        { email: 'sinan@writersden.net', username: 'sinan_script', displayName: 'Sinan Aktaş', bio: 'Senaryo yazarı ve storyboard sanatçısı. Animasyon ve kısa film projeleri.', tagline: 'Hikayenin iskeleti', portfolioLink: 'https://sinanaktas.art', contactInstagram: 'sinanstoryboard', globalRole: client_1.GlobalRole.USER },
        // Organizatör adayları
        { email: 'bahar@orgmail.co', username: 'bahar_org', displayName: 'Bahar Güneş', bio: 'Kültür-sanat etkinlikleri organizatörü. 5 yıldır festival ve sergi düzenliyorum.', tagline: 'Sanatı birleştirmek', contactInstagram: 'bahargunesarts', globalRole: client_1.GlobalRole.ORGANIZER },
        { email: 'volkan@orgmail.co', username: 'volkan_org', displayName: 'Volkan Şimşek', bio: 'Game jam ve hackathon organizatörü. Türkiye\'nin en büyük indie game jam\'ini yönettim.', tagline: 'Oyun geliştiricileri buluşturmak', contactTwitter: 'volkansimsekggj', globalRole: client_1.GlobalRole.ORGANIZER },
        // Şirket / Recruiter profilleri
        { email: 'ik@dreamforge.co', username: 'dreamforge_hr', displayName: 'DreamForge Games', bio: 'Bağımsız oyun stüdyosu. Yetenekli sanatçı ve geliştiriciler arıyoruz.', tagline: 'Hayalleri oyuna dönüştürüyoruz', portfolioLink: 'https://dreamforge.games', globalRole: client_1.GlobalRole.USER },
        { email: 'hr@pixelminds.co', username: 'pixelminds_hr', displayName: 'PixelMinds Studio', bio: 'Mobil oyun ve interaktif deneyim stüdyosu. 50+ kişilik ekip.', tagline: 'Piksellerin ötesini düşün', portfolioLink: 'https://pixelminds.studio', globalRole: client_1.GlobalRole.USER },
        { email: 'talent@kreatifajans.co', username: 'kreatif_hr', displayName: 'Kreatif Ajans', bio: 'Tam hizmet reklam ajansı. Görsel tasarım, motion graphics ve içerik üretimi.', tagline: 'Fikirleri görünür kılmak', portfolioLink: 'https://kreatifajans.com', globalRole: client_1.GlobalRole.USER },
        { email: 'recruit@techarts.co', username: 'techarts_hr', displayName: 'TechArts Digital', bio: 'Dijital ürün stüdyosu. SaaS, mobil ve web platformları geliştiriyoruz.', tagline: 'Teknoloji ve sanat bir arada', portfolioLink: 'https://techarts.digital', globalRole: client_1.GlobalRole.USER },
        { email: 'jobs@storyforge.co', username: 'storyforge_hr', displayName: 'StoryForge Media', bio: 'Animasyon ve VFX stüdyosu. Netflix ve Disney+ için içerik üretiyoruz.', tagline: 'Hikayeleri canlandırmak', portfolioLink: 'https://storyforge.media', globalRole: client_1.GlobalRole.USER },
    ];
    ...
    for (const sub of subscriptions) {
        ...
        const plan = planMap.get(sub.tier);
        if (!user || !plan)
            continue;
    ...
    // ==========================================
    const now = new Date();
    const d = (offsetDays) => new Date(now.getTime() + offsetDays * 86400_000);
    const extraContestDefs = [
        {
            ...
            status: client_1.ContestStatus.APPLICATIONS,
        ...
        },
        {
            ...
            status: client_1.ContestStatus.JUDGING,
            reviewStatus: 'APPROVED',
    ...
    for (const c of extraContestDefs) {
        const { createdByEmail, ...contestData } = c;
        ...
        const contest = await prisma.contest.upsert({
            ...
            create: {
                ...
                approvalMode: client_1.ApprovalMode.AUTO,
            },
        });
    ...
    for (const contest of activeContests.slice(0, 3)) {
        const assignedJuries = allUsers.filter(u => {
            ...
            return u.contestMembers?.some?.((cm) => cm.contestId === contest.id && cm.role === 'JURY');
        });
...
//# sourceMappingURL=seed.marketing.js.map
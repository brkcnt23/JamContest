...
async function main() {
  ...
  const votePairs = [
    { postIdx: 0, voter: buse, type: 'UP' as const },
    { postIdx: 0, voter: emre, type: 'UP' as const },
    { postIdx: 0, voter: nida, type: 'UP' as const },
    { postIdx: 0, voter: testUser, type: 'UP' as const },
    { postIdx: 1, voter: ali, type: 'UP' as const },
    { postIdx: 1, voter: selin, type: 'UP' as const },
    { postIdx: 1, voter: irem, type: 'UP' as const },
    { postIdx: 2, voter: burak, type: 'UP' as const },
    { postIdx: 2, voter: ali, type: 'UP' as const },
    { postIdx: 3, voter: buse, type: 'UP' as const },
    { postIdx: 3, voter: orhan, type: 'UP' as const },
    { postIdx: 3, voter: ayse, type: 'UP' as const },
    { postIdx: 3, voter: testUser, type: 'UP' as const },
    { postIdx: 4, voter: emre, type: 'UP' as const },
    { postIdx: 4, voter: ali, type: 'UP' as const },
    { postIdx: 4, voter: nida, type: 'UP' as const },
    { postIdx: 5, voter: selin, type: 'UP' as const },
    { postIdx: 5, voter: buse, type: 'UP' as const },
    { postIdx: 5, voter: irem, type: 'UP' as const },
    { postIdx: 6, voter: orhan, type: 'UP' as const },
    { postIdx: 6, voter: burak, type: 'UP' as const },
    { postIdx: 7, voter: ali, type: 'UP' as const },
    { postIdx: 7, voter: selin, type: 'UP' as const },
    { postIdx: 8, voter: buse, type: 'UP' as const },
    { postIdx: 8, voter: nida, type: 'UP' as const },
    { postIdx: 9, voter: emre, type: 'UP' as const },
    { postIdx: 9, voter: burak, type: 'UP' as const },
    { postIdx: 9, voter: testUser, type: 'UP' as const },
    { postIdx: 10, voter: ali, type: 'UP' as const },
    { postIdx: 10, voter: ayse, type: 'UP' as const },
    // A few down votes for realism
    { postIdx: 6, voter: selin, type: 'DOWN' as const },
    { postIdx: 8, voter: orhan, type: 'DOWN' as const },
  ];
